...
<img src="docs/banner.svg" alt="LISA// Offensive Web Testing Manifest — 20,200 test cases across 75 categories in 7 attack-surface domains" width="100%" />

<br/>

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=20&duration=2600&pause=900&color=33D6C0&center=true&vCenter=true&width=780&lines=20%2C200+test+cases.+75+categories.+7+domains.;100%25+static.+Zero+backend.+Zero+telemetry.;Your+progress+never+leaves+your+browser.;Built+for+bug+bounty+hunters+%26+pentesters." alt="Typing SVG" />
...
<div align="center">
<img src="docs/screenshot-mock.svg" alt="LISA// checklist UI — expanded category with severity badges, flagged items, methodology tip, and an inline note" width="92%" />
</div>
...
> 3. Replace the `<img>` above with `<img src="docs/demo.gif" ... />`
